...
- **Collaborative filtering** - use `u.data` ratings with SVD to recommend based on user behaviour, not just genre
- **Hybrid model** - combine content and collaborative scores for better accuracy
- **Title enrichment** - weight release year as a feature to surface era-appropriate recommendations
